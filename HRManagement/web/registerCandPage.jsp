                ...
                <div class="container-login100">
                    <div class="wrap-login100">
                        <div class="login100-form">
                            ...
                            <% }%>
                            <p style="color: red; text-align: center;"> <%= (request.getParameter("stt") != null) ? "Email already exists!!!" : ""%></p>
                            <p style="color: red; text-align: center;"> <%= (request.getParameter("vstt") != null) ? "Verify-code invalid!!!" : ""%></p>
                            <p style="color: red; text-align: center;"> <%= (request.getParameter("valstt") != null) ? "Email invalid!!!" : ""%></p>
                        </div>
                    </div>
                </div>
            </div>
